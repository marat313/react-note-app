  ...
  return (
      <section>
          ...
          <form className="create-note_form" onSubmit={handleForm}>
              <input type="text" placeholder="Загаловок" value={title} onChange={(e) => setTitle(e.target.value)} />
              <textarea rows="28" placeholder="Детали заметки" value={details} onChange={(e) => setDetails(e.target.value)}></textarea>
          </form>
      </section>
  );
}
